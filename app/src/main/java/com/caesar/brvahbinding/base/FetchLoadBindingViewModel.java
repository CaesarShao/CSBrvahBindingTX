...
public abstract class FetchLoadBindingViewModel<B> extends BaseBindingViewModel<B> {
    ...
    //下拉监听回调
    public OnUpFetchListener upFetchListener;
    public int mPage;
    ...
    public FetchLoadBindingViewModel(RecyclerView recyclerView) {
        ...
        bindingAdapter.getUpFetchModule().setUpFetchEnable(true);
        bindingAdapter.getUpFetchModule().setStartUpFetchPosition(2);
    }


    protected OnUpFetchListener getUpFetchListener() {
        return new OnUpFetchListener() {
            @Override
    ...
    protected void load(Flowable<List<B>> flowable) {
        ...
        bindingAdapter.getUpFetchModule().setUpFetching(true);
        disposable = flowable.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Consumer<List<B>>() {
                    ...
                    public void accept(List<B> result) throws Exception {
                        bindingAdapter.getUpFetchModule().setUpFetching(false);
                        setData(result);
                    }
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        ...
                        bindingAdapter.getUpFetchModule().setUpFetching(false);
                        bindingAdapter.getUpFetchModule().setUpFetchEnable(false);
