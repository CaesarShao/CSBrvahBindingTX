...
public abstract class TwoListBindingViewModel<A,B> extends BaseViewModel {
    ...
    //设置每个item的占的格数
    public GridSpanSizeLookup spanSizeLookupA;
    //当多布局时,如果item不想继承MultiItemEntity,可以用这个来设置每个itemType
    public BaseMultiTypeDelegate<A> multiTypeDelegatA;
    //空布局
    ...
    //加载的动画
    public ObservableField<BaseQuickAdapter.AnimationType> animationTypeA;
    //加载的自定义动画
    ...
    //设置每个item的占的格数
    public GridSpanSizeLookup spanSizeLookupB;
    //当多布局时,如果item不想继承MultiItemEntity,可以用这个来设置每个itemType
    public BaseMultiTypeDelegate<B> multiTypeDelegatB;
    //空布局
    ...
    //加载的动画
    public ObservableField<BaseQuickAdapter.AnimationType> animationTypeB;
    //加载的自定义动画
    ...
    public TwoListBindingViewModel() {
        ...
        animationTypeA = new ObservableField(BaseQuickAdapter.AnimationType.SlideInBottom);
        if (bindingAdapterA == null) {
            bindingAdapterA = new CSBindingAdapter<>(itemBindingA, itemsA);
        }
        bindingAdapterA.setAnimationFirstOnly(isAnimationFirstOnley());
        ...
        animationTypeB = new ObservableField(BaseQuickAdapter.AnimationType.SlideInBottom);
        if (bindingAdapterB == null) {
            bindingAdapterB = new CSBindingAdapter<>(itemBindingB, itemsB);
        }
        bindingAdapterB.setAnimationFirstOnly(isAnimationFirstOnley());
    }
...
//            bindingAdapter.addData(index,newData);
    ...
    public void setSpanA(GridSpanSizeLookup spanSizeLookup) {
        this.spanSizeLookupA = spanSizeLookup;
    }

    public void setSpanB(GridSpanSizeLookup spanSizeLookup) {
        this.spanSizeLookupB = spanSizeLookup;
    }


    public void setMultiTypeDelegatA(BaseMultiTypeDelegate<A> multiTypeDelegat) {
        this.multiTypeDelegatA = multiTypeDelegat;
    }

    public void setMultiTypeDelegatB(BaseMultiTypeDelegate<B> multiTypeDelegat) {
