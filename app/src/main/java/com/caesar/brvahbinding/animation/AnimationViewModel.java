    ...
    public AdapterView.OnItemSelectedListener getOnItemCli() {
        return new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        animationType.set(BaseQuickAdapter.AnimationType.SlideInBottom);
                        break;
                    case 1:
                        animationType.set(BaseQuickAdapter.AnimationType.AlphaIn);
                        break;
                    case 2:
                        animationType.set(BaseQuickAdapter.AnimationType.ScaleIn);
                        break;
                    case 3:
                        animationType.set(BaseQuickAdapter.AnimationType.SlideInLeft);
                        break;
                    case 4:
                        animationType.set(BaseQuickAdapter.AnimationType.SlideInRight);
                        break;
                }
            }
